...
public class BleWrapper {
    ...
    public BleWrapperUiCallbacks mUiCallback = null;
    ...
    public boolean connect(final String deviceAddress) {
        ...
        if(mBluetoothGatt != null && mBluetoothGatt.getDevice().getAddress().equals(deviceAddress)) {
            ...
            Util.showToast("connect to " + deviceAddress +"=>"+ mBleCallback.toString());
    ...
    {
		for(BluetoothGattService svc : mBluetoothGattServices) //svc.getDevice().equals(mBluetoothDevice) &&
		{
			if 
    ...
    public void getCharacteristicValue(BluetoothGattCharacteristic ch) {
        ...
        // ACCEL Z VALUE
        else if(uuid.equals(UUID.fromString("0000ffa4-0000-1000-8000-00805f9b34fb"))) 
        { 
        	intValue = rawValue[0];
        	ScanningActivity.instance.sendUnityMessage( "zaccel:"+ Integer.toString(intValue) );	
        }   
    ...
    public void setNotificationForCharacteristic(BluetoothGattCharacteristic ch, boolean enabled) 
    {
        ...
        if(success) 
        {
        	Util.showToast(ch.getUuid()+"  SuccessfulNotify");        	
        }
